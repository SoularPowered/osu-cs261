...
/* sort an array pointed to by number with n elements using bubble sort
 * Preconditions: n >= 0, number != NULL
 * Postconditoins: array pointed to by number will be sorted in ascending order
 */
